...
<div id="header-part-top">

    <div id="header-part-top-left-corner" ></div>
   <a href="http://www.khatushyam.in/" style="cursor:pointer;" > <div id="header-part-top-logo"></div></a>
  ...
  <div id="header-banner-part1"></div>
   <div id="header-banner-part2"></div>
    <div id="header-banner-part3"></div>
    <div id="header-banner-part4">
    </div>
    <div id="header-banner-part5"> </div>
    <div id="header-banner-part6"></div>
    <div id="header-banner-part7"></div>
    
  </div>
  <!--------------------------------header banner end---------------------------->
  <!--------------------------------design part start---------------------------->
  <div id="design-part">
    <div id="design-part-1"></div>
    <div id="design-part-2"></div>
    <div id="design-part-3">
      <div id="design-part-3-top">
        <div id="design-part-3-top-left"></div>
        <div id="design-part-3-top-mid"></div>
        <div id="design-part-3-top-right"></div>
      </div>
      <div id="design-part-3-bot">
        <div id="design-part-3-bot-left">
        <div style="margin-top:30px;">
                                         <span style="font-size:16px; color:#939; padding-left:50px;  "> Khatu shyam ji Shyam Baba   </span>
               
 <div id="bak" style="margin-top:10px; padding-left:55px;">
   <p><a class="rig" href="signup.php" > Register</a> &nbsp;| <a class="rig" href="http://www.facebook.com/khatushyam.in" target="_blank"  > FaceBook</a></p>
...
<script type="text/javascript">
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
        ...
        <div id="design-part-3-bot-mid"></div>
        <div id="design-part-3-bot-right"><div style="margin-top:25px; ">
